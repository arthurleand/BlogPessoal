package com.BlogPessoal.App.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.BlogPessoal.App.controller")).paths(PathSelectors.any())
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Blog Pessoal").description("Projeto API Spring - Blog Pessoal")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("https://github.com/arthurleand")
				.contact(contact()).build();
	}

	private static Contact contact() {
		return new Contact("Arthur Leandro", "https://github.com/arthurleand", "arthurleandrodev@gmail.com");
	}
